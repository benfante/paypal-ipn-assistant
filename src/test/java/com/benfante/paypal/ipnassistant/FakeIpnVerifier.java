...
import com.benfante.paypal.ipnassistant.IpnVerifier;
import com.benfante.paypal.ipnassistant.IpnData;

/**
 * A verifier used for tests.
 *
 * @author <a href="mailto:lucio.benfante@gmail.com">Lucio Benfante</a>
 */
public class FakeIpnVerifier implements IpnVerifier {
    private String result = "VERIFIED";
